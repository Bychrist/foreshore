                                                  ...
                                                  <div class="inner-box">
                                                      <div class="image-box"><img src="{{$mainPix->title}}" alt="">
                                                          <div class="overlay-box">
                                                              <div class="content">
                                                                  <a class="lightbox-image" href="{{$mainPix->title}}" title="{{$mainPix->PixCategory->category_name}}" data-fancybox-group="example-gallery"><span class="icon flaticon-plus"></span></a>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
